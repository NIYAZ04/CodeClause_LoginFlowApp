package com.example.firebaseapp.app.data

import android.util.Log
import androidx.compose.runtime.mutableStateOf
import androidx.lifecycle.ViewModel
import com.example.firebaseapp.app.data.rules.Validator
...
class SignupViewModel : ViewModel() {
    ...
    private fun validateDataWithRules() {
       val fNameResult=Validator.validateFirstName(
        ...
        val emailResult=Validator.validateLastName(
            lName = registrationUIState.value.email
        )
        val passwordResult=Validator.validateLastName(
            lName = registrationUIState.value.password
        )
        val privacyPolicyResult=Validator.validatePrivacyPolicyAcceptance(
            statusValue = registrationUIState.value.privacyPolicyAccepted
        )
        Log.d(TAG,"Inside_validaDataWithRules")
        ...
        FirebaseAuth
            ...
            .addOnCompleteListener {
                ...
                if(it.isSuccessful){
                    ...
                    FirebaseFirstRouter.navigateTo(Screen.HomeScreen)
                }
